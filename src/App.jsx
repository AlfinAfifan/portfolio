    ...
    <div className="bg-slate-100">
      ...
      <div id="homepage" className="flex items-center lg:gap-14 justify-between font-montserrat text-gray-800 py-10 lg:py-32 lg:mb-20 w-full lg:px-60">
        <div className="flex flex-col gap-2 items-center lg:items-start px-7 lg:px-0 lg:w-[80%]">
          ...
          <a href="https://drive.google.com/file/d/1inU06yLtPeMgAFC_F3QOGmzbrJoB-V_l/view?usp=sharing" className="bg-sky-700 mt-8 px-5 text-sm lg:text-base hover:bg-sky-800 py-2 rounded-full text-white">
            Curriculum Vitae
          </a>
        </div>
      ...
      <div id="about" className=" flex flex-col items-center font-montserrat text-gray-800 py-20 lg:py-40">
        <div className="px-7 lg:px-60 flex flex-col">
          ...
          <div className="flex items-center gap-7 mt-5 lg:mt-10 justify-start">
          ...
          <div className="grid gap-y-5 grid-cols-1 lg:grid-cols-2 lg:gap-x-20 mt-7">
            {data.map((video) => (
              <div className="flex flex-col gap-3 mt-2 items-center" key={video.id}>
                ...
                <h1 className="font-semibold">Online Shop</h1>
                <p className="text-center text-sm lg:text-base">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptates eaque, debitis modi officia natus ducimus quidem ea earum fugit eum.</p>
              </div>
            ))}
          </div>
        </div>
